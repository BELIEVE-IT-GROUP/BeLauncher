...
| Notas / Inbox | Parcial fuerte | Nota Markdown, evidencia de audio/importación con ruta original, revisión persistente, propuesta de memoria, reintento de transcripción, filtros por tipo y proyección común `InboxItem` | Staging de adjuntos si se decide copiar alguno |
...
| Ingesta | En progreso | CorpusRunner, historial de runs, episodios, importadores, checkpoint durable, reintentos por fuente, progreso común durable por fuente y Centro de Fuentes con Mail/Messages/Notes | Aplicar staging también a importaciones/adjuntos y validar recuperación en una Mac limpia |
...
| Vault staging | Vault, CorpusFiles, Database | CorpusFolder y Vault usan staging con UUID, manifiesto durable, recuperación al iniciar y confirmación multiarchivo; hay prueba de reapertura tras interrupción | Aplicar el mismo contrato a importaciones/adjuntos si entran en el flujo de memoria | P1 |
