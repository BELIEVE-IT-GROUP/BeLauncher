...
extension SpanishStrings {
    ...
    static let settings: [String: String] = [
        ...
        "90 days": "90 días",
        "Latest Brain file: %@": "Último archivo del Brain: %@",
        "One Brain update today: %@": "Una actualización del Brain hoy: %@",
        "%@ Brain updates today. Latest: %@": "%@ actualizaciones del Brain hoy. Última: %@",
        "No new Brain files today. Last file: %@": "Hoy no hay archivos nuevos del Brain. Último: %@",
        "One work thread active today: %@": "Un hilo de trabajo activo hoy: %@",
        "%@ work threads active today. Latest: %@": "%@ hilos de trabajo activos hoy. Último: %@",
        "Read": "Leer",
        "Recent work: %@": "Trabajo reciente: %@",
        "Nothing has landed in the Brain yet today.": "Hoy todavía no ha entrado nada al Brain.",
        "Nothing new has landed in the Brain today.": "Hoy no ha entrado nada nuevo al Brain.",
        "Write note": "Escribir nota",
        "What matters": "Qué importa",
        "One thing needs attention: %@": "Una cosa necesita atención: %@",
        "%@ things need attention. Top: %@": "%@ cosas necesitan atención. Principal: %@",
        "Ask why": "Preguntar por qué",
        "Most active today: %@": "Más activo hoy: %@",
        "Most recent active thread: %@": "Hilo activo más reciente: %@",
        "Pulse has nothing urgent yet.": "Pulso no ve nada urgente todavía.",
        "What you can do now": "Qué puedes hacer ahora",
        "One voice note needs transcription: %@": "Una nota de voz necesita transcripción: %@",
        "%@ voice notes need transcription. Start with: %@": "%@ notas de voz necesitan transcripción. Empieza por: %@",
        "Transcribe first": "Transcribir primero",
        "One Inbox item needs review: %@": "Un elemento del Inbox necesita revisión: %@",
        "%@ Inbox items need review. Start with: %@": "%@ elementos del Inbox necesitan revisión. Empieza por: %@",
        "Review first": "Revisar primero",
        "Ask the Brain to turn the top attention item into a next step.":
            "Pídele al Brain convertir el punto principal de atención en un siguiente paso.",
        "Transcribe: %@": "Transcribir: %@",
        "Review: %@": "Revisar: %@",
        "Ask the Brain about %@": "Preguntar al Brain sobre %@",
        "Write a note or import a file to give the Brain something useful.":
            "Escribe una nota o importa un archivo para darle algo útil al Brain.",
        "Open graph": "Abrir grafo",
        "Focus": "Enfocar",
        "Allow": "Permitir",
