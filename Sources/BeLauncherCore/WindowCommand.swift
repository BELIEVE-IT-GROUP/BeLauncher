...
public struct WindowCommand: Sendable, Equatable, Identifiable {
    ...
    public static let all: [WindowCommand] = [
        .init(id: "left-half", title: "Ventana: mitad izquierda", keywords: ["izquierda", "left", "half"],
              symbol: "rectangle.lefthalf.filled", layout: .leftHalf),
        .init(id: "right-half", title: "Ventana: mitad derecha", keywords: ["derecha", "right", "half"],
              symbol: "rectangle.righthalf.filled", layout: .rightHalf),
        .init(id: "top-half", title: "Ventana: mitad superior", keywords: ["arriba", "top"],
              symbol: "rectangle.tophalf.filled", layout: .topHalf),
        .init(id: "bottom-half", title: "Ventana: mitad inferior", keywords: ["abajo", "bottom"],
              symbol: "rectangle.bottomhalf.filled", layout: .bottomHalf),
        .init(id: "top-left", title: "Ventana: esquina superior izquierda", keywords: ["cuarto", "quarter"],
              symbol: "rectangle.inset.topleft.filled", layout: .topLeft),
        .init(id: "top-right", title: "Ventana: esquina superior derecha", keywords: ["cuarto", "quarter"],
              symbol: "rectangle.inset.topright.filled", layout: .topRight),
        .init(id: "bottom-left", title: "Ventana: esquina inferior izquierda", keywords: ["cuarto", "quarter"],
              symbol: "rectangle.inset.bottomleft.filled", layout: .bottomLeft),
        .init(id: "bottom-right", title: "Ventana: esquina inferior derecha", keywords: ["cuarto", "quarter"],
              symbol: "rectangle.inset.bottomright.filled", layout: .bottomRight),
        .init(id: "left-third", title: "Ventana: tercio izquierdo", keywords: ["tercio", "third"],
              symbol: "rectangle.split.3x1", layout: .leftThird),
        .init(id: "centre-third", title: "Ventana: tercio central", keywords: ["tercio", "third", "centro"],
              symbol: "rectangle.split.3x1.fill", layout: .centreThird),
        .init(id: "right-third", title: "Ventana: tercio derecho", keywords: ["tercio", "third"],
        ...
        .init(id: "almost-maximise", title: "Ventana: casi maximizar", keywords: ["casi", "almost"],
              symbol: "rectangle.inset.filled", layout: .almostMaximise),
        .init(id: "centre", title: "Ventana: centrar", keywords: ["centrar", "centre", "center"],
              symbol: "rectangle.center.inset.filled", layout: .centre),
        .init(id: "next-display", title: "Ventana: pantalla siguiente", keywords: ["pantalla", "monitor", "display"],
              symbol: "display.2", layout: .nextDisplay),
        .init(id: "previous-display", title: "Ventana: pantalla anterior", keywords: ["pantalla", "monitor"],
